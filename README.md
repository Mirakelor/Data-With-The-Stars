<!-- 版权信息 -->
©2026 by COMAP \| [www.comap.org](http://www.comap.org) \| [www.mathmodels.org](http://www.mathmodels.org) \| info@comap.org \|
...
Celebrities are partnered with professional dancers and then perform dances each week. A panel of expert judges scores each couple’s dance, and fans vote (by phone or online) for their favorite couple that week. Fans can vote once or multiple times up to a limit announced each week.  
Further, fans vote for the star they wish to keep, but cannot vote to eliminate a star. The judge and fan votes are combined in order to determine which couple to eliminate (the lowest combined score) that week. Three (in some seasons more) couples reach the finals and in the week of the finals the combined scores from fans and judges are used to rank them from 1st to 3rd (or 4th, 5th).
...
`2026_MCM_Problem_C_Data.csv` – contestant information, results, and judges scores by week for seasons 1 – 34. The data description is provided in Table 1.
...
| `weekX_judgeY_score`         | Score from judge Y in week X                |                                     |
...
6. N/A values occur in the dataset for:
   - a. the 4th judge score if there is no 4th judge for that week (usually there are 3)
